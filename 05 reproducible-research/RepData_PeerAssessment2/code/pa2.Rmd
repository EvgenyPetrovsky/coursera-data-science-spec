...
# amount orders (K = 10^3, M - 10^6, B = 10^9)
...
We build top five rating of impact on property and health. First we need to 

````{r "plot top events"}
ggplot(
  subset(top5ev, IMPACT %in% c("INJURIES", "FATALITIES")),
  aes(x=reorder(EVTYPE, place), y=VALUE, fill = EVTYPE)
  ) +
